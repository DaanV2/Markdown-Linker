...
- In the case of a function, the string value of the argument's value is passed to it,
  and the return value is used as the [[Ultima](../../../Other/Calendar.md)](../../../Other/[Calendar](../../../Other/Calendar.md).md)te value.
...
For custom handlers that [[Wish](https://www.dndbeyond.com/spells/wish)](https://www.dndbeyond.com/spells/[Wish](https://www.dndbeyond.com/spells/wish)) to behave as flags, you may pass the function through `arg.flag()`:
