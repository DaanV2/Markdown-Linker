...
JavaScript implementation of the timer APIs; `setTimeout`, `clearTimeout`, `setIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te`, `clearIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te`, `setInterval`, `clearInterval`, `requestAnimationFrame`, `cancelAnimationFrame`, `requestIdleCallback`, and `cancelIdleCallback`, along with a clock instance that controls the flow of time. FakeTimers also provides a `Date` implementation that gets its time from the clock.
...
Please note that this is achieved using the original setIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te() API at a certain
...
| `config.toFake`                  | String[]    | ["setTimeout", "clearTimeout", "setIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te", "clearIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te","setInterval", "clearInterval", "Date", "requestAnimationFrame", "cancelAnimationFrame", "requestIdleCallback", "cancelIdleCallback", "hrtime", "performance"] | an array with explicit function names (or objects, in the case of "performance") to hijack. _When not set, FakeTimers will automatically fake all methods **except** `nextTick`_ e.g., `FakeTimers.install({ toFake: ["setTimeout","nextTick"]})` will fake only `setTimeout` and `nextTick` |
...
In Node.js `setIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te` returns a timer object. FakeTimers will do the same,
...
Clears the timer given the ID or timer object, as long as it was created using
`setIm[[Media](../../../../Other/Calendar.md)](../../../../Other/[Calendar](../../../../Other/Calendar.md).md)te`.
