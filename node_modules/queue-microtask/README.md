...
In Node, `queueMicrotask` and `process.nextTick` are [essentially equivalent](https://nodejs.org/api/globals.html#globals_queuemicrotask_callback), though there are [subtle differences](https://github.com/YuzuJS/setIm[[Media](../../../Other/Calendar.md)](../../../Other/[Calendar](../../../Other/Calendar.md).md)te#macrotasks-and-microtasks) that don't matter in most situations.
...
This package (`queue-microtask`) is four times smaller than `im[[Media](../../../Other/Calendar.md)](../../../Other/[Calendar](../../../Other/Calendar.md).md)te`, twice as small as `asap`, and twice as small as using `process.nextTick` and letting the browser bundler shim it automatically.
