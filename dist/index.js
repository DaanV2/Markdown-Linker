...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.saveDocument = exports.loadDocument = void 0;
const fs = __importStar(__nccwpck_require__(7147));
...
function saveDocument(doc, content) {
    return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isInLink = void 0;
function isInLink(text, offset) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SerializedTagMap = exports.MarkdownTags = void 0;
var MarkdownTags;
...
})(SerializedTagMap = exports.SerializedTagMap || (exports.SerializedTagMap = {}));
//# sourceMappingURL=MarkdownTags.js.map
...
const Markdown_1 = __nccwpck_require__(8627);
...
class Replacer {
    ...
    replaceDocuments(files) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(files.map((file) => this.replaceDocument(file)));
        });
    }
    replaceDocument(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content !== newContent) {
                ...
                return (0, Document_1.saveDocument)(file, newContent);
            }
        });
    }
    replace(text, currentDoc) {
        ...
        this.tags.forEach((item) => {
            ...
            for (let i = 0; i < max; i++) {
                ...
                lines[i] = line.replace(search, (match, tag, offset, original) => {
                    if ((0, Markdown_1.isInLink)(original, offset))
                        return match;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (Array.isArray(json)) {
                    json.forEach((item) => {
                        if (MarkdownTags_1.SerializedTagMap.is(item)) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(8857);
